...
const App: FC = () => {
  ...
  // Create dynamic MUI theme based on user customizations and dark mode
  const muiTheme = useMemo(() => {
    const baseTheme = createMuiTheme(applicationConfig?.customTheme, DEFAULT_THEME);

    // Override with dark mode if enabled
    if (darkMode) {
      return createTheme({
        ...baseTheme,
        palette: {
    ...
    return baseTheme;
  }, [applicationConfig?.customTheme, darkMode]);
