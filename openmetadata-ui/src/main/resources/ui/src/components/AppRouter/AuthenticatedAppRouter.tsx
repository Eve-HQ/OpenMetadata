...
import CustomNavigate from '../common/CustomNavigate/CustomNavigate';
import {
...
const AuthenticatedAppRouter: FunctionComponent = () => {
  ...
  return (
    <Routes>
      ...
      />
      <Route element={<CustomNavigate to={ROUTES.MY_DATA} replace />} path={ROUTES.SIGNIN} />
      <Route
        element={<CustomNavigate to={ROUTES.MY_DATA} replace />}
      ...
      />
      <Route element={<CustomNavigate to={ROUTES.NOT_FOUND} replace />} path="*" />
    </Routes>
  );
};
